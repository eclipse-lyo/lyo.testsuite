...
public class ModelUtil {
     ...
     */
    public static Model deserializeModel(byte[] bytes) throws JenaException {
        if (bytes == null)
     ...
     * @throws JenaException
     */
    public static Model deserializeModel(byte[] bytes, String lang) throws JenaException {
        if (bytes == null)
            throw new IllegalArgumentException(
                    Messages.getServerString("model.util.bytes.null")); // $NON-NLS-1$
     ...
     * @throws JenaException
     */
    public static Model deserializeModel(InputStream in) throws JenaException {
     ...
     * @throws JenaException
     */
    public static Model deserializeModel(InputStream in, String lang) throws JenaException {
        if (in == null)
            throw new IllegalArgumentException(
     ...
     * @throws JenaException
     */
    public static byte[] serializeModel(Model model) throws JenaException {
     ...
     * @throws JenaException
     */
    public static byte[] serializeModel(Model model, String lang) throws JenaException {

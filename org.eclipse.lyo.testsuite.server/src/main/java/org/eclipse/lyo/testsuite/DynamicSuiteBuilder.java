        ...
        if (OSLCConstants.OSLC_CM_V2.equals(testVersions)
            ...
            if (OSLCConstants.OSLC_CM_V2.equals(testVersions)
                ...
                if (OSLCConstants.OSLC_CM_V2.equals(testVersions)) {
                    ...
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.cm.ChangeRequestRdfXmlTests.class);
                    if (supportRdfXmlAbbrev) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.cm.ChangeRequestXmlTests.class);
                    }

                    if (supportOslcJson) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.cm.ChangeRequestJsonTests.class);
                    ...
                    if (supportOslcJson) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.CreateAssetJsonTest.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.GetAndUpdateJsonTests.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.UsageCaseJsonTests.class);
                    }

                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.asset.CreateAssetRdfXmlTest.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.asset.GetAndUpdateRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.asset.UsageCaseRdfXmlTests.class);

                    if (supportRdfXmlAbbrev) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.CreateAssetXmlTest.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.GetAndUpdateXmlTests.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.asset.UsageCaseXmlTests.class);
                    }
                } else if (OSLCConstants.OSLC_RM_V2.equals(testVersions)) {
                    log.info("Setting up to test RM v2 features");
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.rm.RequirementRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.rm.RequirementCollectionRdfXmlTests
                                    .class);

                    if (supportRdfXmlAbbrev) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.rm.RequirementXmlTests.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.rm.RequirementCollectionXmlTests
                                        .class);
                    }
                } else if (OSLCConstants.OSLC_AUTO_V2.equals(testVersions)) {
                    log.info("Setting up to test Automation v2 features");
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.auto.AutomationPlanRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.auto.AutomationRequestRdfXmlTests
                                    .class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.auto.AutomationResultRdfXmlTests
                                    .class);

                    if (supportRdfXmlAbbrev) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationRequestXmlTests
                                        .class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationPlanXmlTests.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationResultXmlTests
                                        .class);
                    }

                    if (supportOslcJson) {
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationPlanJsonTests
                                        .class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationRequestJsonTests
                                        .class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.auto.AutomationResultJsonTests
                                        .class);
                    }
                    ...
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.qm.TestExecutionRecordRdfXmlTests
                                    .class);
                    ...
                    if (supportRdfXmlAbbrev) {
                        ...
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.qm.TestScriptXmlTests.class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.qm.TestExecutionRecordXmlTests
                                        .class);
                        testsToRun.add(
                                org.eclipse.lyo.testsuite.oslcv2.qm.TestResultXmlTests.class);
                    }
                } else if (OSLCConstants.OSLC_PM_V2.equals(testVersions)) {
                    log.info("Setting up to test PM v2 features");
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordComputerSystemRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordAgentRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordDatabaseRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordProcessRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordSoftwareModuleRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordSoftwareServerRdfXmlTests.class);
                    testsToRun.add(
                            org.eclipse.lyo.testsuite.oslcv2.pm
                                    .PerformanceMonitoringRecordStorageVolumeRdfXmlTests.class);
                }
            }

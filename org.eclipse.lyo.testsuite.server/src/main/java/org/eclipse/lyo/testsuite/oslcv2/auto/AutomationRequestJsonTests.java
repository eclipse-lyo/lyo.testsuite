...
/**
 * This class provides JUnit tests for the validation of a automation request returned by accessing the auto request's
 * URL directly. It runs the equality query from the properties file and grabs the first result to test against,
 * checking the relationship of elements in the JSON representation of the auto request
 */
public class AutomationRequestJsonTests extends CoreResourceJsonTests {

    public void initAutomationRequestJsonTests(String thisUrl)
    ...
    @ParameterizedTest
    public void autoRequestHasAtLeastOneState(String thisUrl) throws JSONException {
        initAutomationRequestJsonTests(thisUrl);
    ...
    @MethodSource("getAllDescriptionUrls")
    @ParameterizedTest
    public void autoRequestHasAtMostOneDesiredState(String thisUrl) throws JSONException {
        initAutomationRequestJsonTests(thisUrl);
    ...
    @MethodSource("getAllDescriptionUrls")
    @ParameterizedTest
    public void autoRequestHasOneExecutesLink(String thisUrl) throws JSONException {
        initAutomationRequestJsonTests(thisUrl);

...
<xsl:template name="JS-escape">
    ...
    <xsl:param name="tmp1" select="fn:replace(string($string),'\\','\\\\')"/>
    <xsl:param name="tmp2" select="fn:replace(string($tmp1),&quot;'&quot;,&quot;\\&apos;&quot;)"/>
    <xsl:param name="tmp3" select="fn:replace(string($tmp2),&quot;&#10;&quot;,'\\n')"/>
 	<xsl:param name="tmp4" select="fn:replace(string($tmp3),&quot;&#13;&quot;,'\\r')"/>
 	<xsl:param name="tmp5" select="fn:replace(string($tmp4),&quot;&#xa;&quot;,'\\n')"/>

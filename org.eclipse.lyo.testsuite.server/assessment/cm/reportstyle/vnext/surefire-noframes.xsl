...
<xsl:variable name="propsFileName">
	<xsl:call-template name="substring-after-last">
		<xsl:with-param name="string" select="/testsuite/properties/property[@name='props']/@value" />
		<xsl:with-param name="delimiter" select="'/'" />
	</xsl:call-template>
</xsl:variable>
<xsl:variable name="propsFileFolderPath" select="substring-before(/testsuite/properties/property[@name='props']/@value,$propsFileName)" />
...
<xsl:template match="testsuite">
	...
	<xsl:template name="compliancepart">
        ...
        <xsl:variable name="passedMustCount" select="count(/testsuite/testcase[@assessment='passedMust'])"/>
        <xsl:variable name="failedMustCount" select="count(/testsuite/testcase[@assessment='failedMust'])"/>
        <xsl:variable name="errorMustCount">
        	<xsl:choose>
        		<xsl:when test="/testsuite/testcase[@assessment='passedMust' or @assessment='failedMust']//error">
        			<xsl:value-of select="count(/testsuite/testcase[@assessment='passedMust' or @assessment='failedMust']//error)"/>
        		</xsl:when>
        		<xsl:otherwise>
        ...
        <xsl:variable name="passedShouldCount" select="count(/testsuite/testcase[@assessment='passedShould'])"/>
        <xsl:variable name="failedShouldCount" select="count(/testsuite/testcase[@assessment='failedShould'])"/>
        <xsl:variable name="mayCount" select="count($spec//testcase[@level='MAY'])"/>
        <xsl:variable name="passedMayCount" select="count(/testsuite/testcase[@assessment='passedMay'])"/>
        <xsl:variable name="failedMayCount" select="count(/testsuite/testcase[@assessment='failedMay'])"/>
        ...
        <div class="Properties">
                <a>
                    <xsl:attribute name="href">javascript:displayProperties('<xsl:value-of select="/testsuite/properties/property[@name='props']/@value"/>');</xsl:attribute>
...
<xsl:template name="substring-after-last">
  ...
  <xsl:template name="OSLCProperties">
  	...
  	<!-- OSLC Config Value Pairs -->
	cur = TestCases['<xsl:value-of select="/testsuite/properties/property[@name='props']/@value"/>'] = new Array();
